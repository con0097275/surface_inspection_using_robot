...
def main(args):
    ...
    method = args.method
    dtype = args.dtype
    # model_path = "saved_models/crackdataset/wall/baselineCAE/ssim/13-04-2023_15-10-53/baselineCAE_b6_e13.hdf5"
    # method = "ssim"
    # dtype = "float64"
    ...
    _, index_array_ft, _, classes_ft = train_test_split(
        index_array,
        classes,
        test_size=config.FINETUNE_SPLIT,   #edit
        random_state=42,
        stratify=classes,
    )
...
def plot_min_area_threshold(dict_finetune, index_best=None, save_dir=None):
    ...
    with plt.style.context("seaborn-darkgrid"):
        ...
        if save_dir is not None:
            plt.savefig(os.path.join(save_dir, "min_area_threshold_plot12.png"))
...
def plot_scores(dict_finetune, index_best=None, save_dir=None):
    ...
    with plt.style.context("seaborn-darkgrid"):
        ...
        #edit
        if save_dir is not None:
            plt.savefig(os.path.join(save_dir, "scores_plot1.png"))
